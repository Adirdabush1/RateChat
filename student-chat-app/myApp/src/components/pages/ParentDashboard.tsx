...
const ParentDashboard: React.FC = () => {
  ...
  if (isLoading) return <div className="text-center mt-10 text-xl">⏳ Loading data...</div>;
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto" dir="ltr">
      ...
      {student.flaggedMessages.length === 0 ? (
