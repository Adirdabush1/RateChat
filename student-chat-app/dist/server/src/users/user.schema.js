...
let User = (() => {
    ...
    let _parentEmail_decorators;
    let _parentEmail_initializers = [];
    let _parentEmail_extraInitializers = [];
    ...
    var User = class {
        ...
        static {
            ...
            _role_decorators = [(0, mongoose_1.Prop)({ default: 'student' })];
            _parentEmail_decorators = [(0, mongoose_1.Prop)()];
            _score_decorators = [(0, mongoose_1.Prop)({ default: 0 })];
            ...
            __esDecorate(null, null, _parentEmail_decorators, { kind: "field", name: "parentEmail", static: false, private: false, access: { has: obj => "parentEmail" in obj, get: obj => obj.parentEmail, set: (obj, value) => { obj.parentEmail = value; } }, metadata: _metadata }, _parentEmail_initializers, _parentEmail_extraInitializers);
        ...
        parentEmail = (__runInitializers(this, _role_extraInitializers), __runInitializers(this, _parentEmail_initializers, void 0));
        score = (__runInitializers(this, _parentEmail_extraInitializers), __runInitializers(this, _score_initializers, void 0));
        constructor() {
